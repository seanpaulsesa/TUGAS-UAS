...
<div class="row no-gutters">
	...
	<ul class="nav flex-column ml-3 mt-4 mb-4 mr-4">
		...
		<li class="nav-item">
			<a class="nav-link text-white" href=""><i class="fa-solid fa-square-plus mr-2"></i>Tambah Mahasiswa</a>
			<hr class="bg-secondary">
		</li>
		<li class="nav-item">
		...
		<li class="nav-item">
			<a class="nav-link text-white" href=""><i class="fa-solid fa-right-from-bracket mr-2"></i>Keluar</a>
			<hr class="bg-secondary">
		</li>
	</ul>	
	</div>
	...
	<div class="col-md-9 p-5 pt-2">
		...
		<div class="alert alert-primary" role="alert">
			<marquee>Welcome to APK Pace Koding Pro_Internet - Kelas A</marquee>
		</div>
	...
	<div class="col-md-9">
		<div class="card-footer">
			<p>APK ini Dibuat : Oleh Pace Koding</p>
		</div>
</div>
</body>
</html>